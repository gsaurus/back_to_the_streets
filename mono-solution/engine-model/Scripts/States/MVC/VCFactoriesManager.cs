...
namespace RetroBread{
	...
	public class VCFactoriesManager:Singleton<VCFactoriesManager>{
		...
		// Factory delegates
		public delegate Controller<T> CreateControllerDelegate<T>(T model) where T:Model<T>;
		public delegate View<T> CreateViewDelegate<T>(T model) where T:Model<T>;
		...
		public void RegisterControllerFactory<T>(string identifier, CreateControllerDelegate<T> factory) where T:Model<T>{
			controllerFactories[identifier] = factory;
		}

		// Register View factory
		public void RegisterViewFactory<T>(string identifier, CreateViewDelegate<T> factory) where T:Model<T>{
			viewFactories[identifier] = factory;
		}


		// Create a controller with the requested factory
		public Controller<T> CreateController<T>(string identifier, T model) where T:Model<T>{
			object obj;
		...
		public View<T> CreateView<T>(string identifier, T model) where T:Model<T>{
			object obj;
