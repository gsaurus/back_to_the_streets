...
//		}
//
//		public bool Evaluate(HUDViewBehaviour model, List<GenericEventSubject<HUDViewBehaviour>> subjects){
//			Storage.HUDObject hudObj = model.hudObjectData;
//			if (hudObj.attackAndGrabDelegation) {
//				return delegationCondition.Evaluate(model, subjects);
//			} else {
//				return nonDelegationCondition.Evaluate(model, subjects);
//			}
//		}
//	}
//
