...
// parameterless
public class EntityBoolCondition: GenericTriggerCondition<GameEntityModel>{
...
public class SingleEntityBoolCondition<T>: GenericTriggerCondition<GameEntityModel>{
