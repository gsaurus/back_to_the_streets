...
namespace RetroBread{
	...
	#region Builders
	    ...
	    private class BuildSetDeltaPosition: InternEventBuilder{
	        ...
	        public override string ToString(GenericParameter parameter){
	            string paramsString = parameter.SafeFloat(0) + ", " + parameter.SafeFloat(1) + ", " + parameter.SafeFloat(2);
	            return "pos"
		...
		// vel(2.1, 4.2, 5.3)
		private class BuildAddImpulse: InternEventBuilder{
			public BuildAddImpulse():base("Add impulse"){}
			public override string ToString(GenericParameter parameter){
				string paramsString;
			...
			public override void Build(GameObject parent, GenericParameter parameter){
				InstantiateSubject(parent, parameter, 0);
				FloatInputFieldParam.Instantiate(parent, parameter, 0, "Impulse X:");
				FloatInputFieldParam.Instantiate(parent, parameter, 1, "Impulse Y:");
				FloatInputFieldParam.Instantiate(parent, parameter, 2, "Impulse Z:");
				BoolToggleParam.Instantiate(parent, parameter, 0, "Use percentage of current impulse");
			}
		}
	    ...
	    private class BuildSetVariable: InternEventBuilder{
			...
			public override void Build(GameObject parent, GenericParameter parameter){
	            ...
	            IntInputFieldParam.Instantiate(parent, parameter, 3, "Or select value or as percentage:");
			}
		}
